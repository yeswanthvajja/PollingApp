...
import com.polling.security.AuthEntryPointJwt;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow local development and GCP deployment
        configuration.setAllowedOriginPatterns(Arrays.asList("*")); // Use patterns instead of origins when credentials=true
